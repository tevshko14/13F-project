...
# Re-export ``build_stock_data_bundle`` for ``web.py``, which imports
# it via ``from filings.routers.redesign_preview import build_stock_data_bundle``.
# Now lives in ``_redesign.stock``; this keeps the public surface stable.
